...
class IntroduceContoller extends Controller
{
    ...
    {
        //$member = \App\Member::where('userId',$id)->first();
        $member = \App\Member::where('id',$id)->first();
        return view('introduce.edit', compact('member'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($users){ 
            //$introduces = \App\Member::where('userId',$id)->update([
            $introduces = \App\Member::where('id',$id)->update([  
